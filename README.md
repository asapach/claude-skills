...
### [pair-code-review](./pair-code-review/)
...
**Triggers on:** "check my progress", "what do you think?", "review what I have so far", "pair with me", "look at my changes", `/pair-code-review`

## Installation

```bash
/plugin marketplace add asapach/claude-skills
/plugin install pair-code-review@asapach-skills
```
